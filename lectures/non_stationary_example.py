...
from learners.SWTS_Learner import *
...
for i in range(0, n_phases):
    ...
    ts_instantaneous_regret[i*phases_len : (i+1)*phases_len] = opt_per_phases[i] - np.mean(ts_reward_per_experiment, axis=0)[i*phases_len : (i+1)*phases_len]
