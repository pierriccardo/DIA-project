...
class Experiment7_b():
    ...
    def __init__(self):
        ...
        for macro in range(3):
            ...
            self.opt[macro] = np.max(means * (self.opt_pricing[macro] - self.cm.mean_cc(self.bids)))
        ...
        for e in tqdm(range(0, self.n_experiments)):
            ...
            for t in range(0,self.T): # 1 round is one day
                ...
                for macro in range(3):
                    ...
                    reward = buyers[macro]*prices[macro]-cost[macro]
    ...
    def plot(self):
        ...
        plt.savefig("img/experiments/experiment_7_Davide.png")
